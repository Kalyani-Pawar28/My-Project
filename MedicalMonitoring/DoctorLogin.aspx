<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="DoctorLogin.aspx.cs" Inherits="Patient_Health_Monitoring_System.DoctorLogin" %>
...
<body class="bg-img" >
  ...
  <div class="container" style="width: 623px; height: 225px;">
    ...
    <button type="submit" class="cancelbtn" runat="server" id="btnLogin">Login</button>
  ...
  <div class="container" style="text-align:center">
    ...
    <span class="psw"><a href="DoctorRegistration.aspx">New Registration</a></span></b>
  </div>
    </div>
    </form>
</body>
